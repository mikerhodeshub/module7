                ...
                <Card.Text>
                    <Container fluid>
                        ...
                        <Row>
                            ...
                            <Col md="auto"><input type="text" name="dateHired" defaultValue={this.state.employee.dateHired} /></Col>
                        </Row>    
                        <Row>
                            <Col md={2}>Currently Employed:</Col>    
                            <Col md="auto"><input type="checkbox" name="currentlyEmployed" defaultChecked={this.state.employee.currentlyEmployed} /><br/></Col>
                        </Row>
                            <Button className="my-3" type="submit" variant="primary" size="sm"></Button>
                            <Alert variant={this.state.alertColor} show={this.state.alertVisible}>{this.state.alertMessage}</Alert>
                        </form>
                    </Container>
                </Card.Text>
            </Card.Body>
